    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                agenda.Add(new Agendamento { Id = 2, ServicoSolicitado = new ServicoSolicitado { Id = 2, Servico = meusServicos.Servicos.First()}, 
                            DtAgendamento = new DateTime(2021, 1, 29, 12, 0, 0) });
                agenda.Add(new Agendamento { Id = 2, ServicoSolicitado = new ServicoSolicitado { Id = 3, Servico = meusServicos.Servicos.First()},
                ...
                agendamento.IncluirAgendamento(1, meusClientes.Clientes.First(), 
                    new ServicoSolicitado { Id = 1, Servico = meusServicos.Servicos.First() }, new DateTime(2021, 1, 29, 10, 0, 0), agenda);
